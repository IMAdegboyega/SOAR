export const features = [
  {
    ...
    title: "Achieve more with less effort",
    text: "With SOAR, tedious tasks become a thing of the past. Automation and intelligent processes elevate your productivity to new levels—like an extra cup of coffee, minus the jitters.",
    button: {
  ...
  },
  {
    ...
    text: "Protecting your data is our top priority. With cutting-edge encryption and advanced privacy controls, SOAR keeps your information secure—locked down tighter than Fort Knox.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "How simple is it to set up SOAR?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
    id: "1",
    question: "Can I integrate SOAR with other platforms?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
...
export const testimonials = [
  {
    ...
    comment:
      "SOAR's customer support is second to none! They’re like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Mark Erixon",
  ...
  },
  {
    ...
    comment:
      "Switched to SOAR last month, and I'm already seeing results. Best decision for our team!",
  },
  {
    id: "5",
    name: "Jim Bradley",
